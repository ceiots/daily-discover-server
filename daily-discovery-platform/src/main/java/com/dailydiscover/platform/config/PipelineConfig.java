...
public class PipelineConfig {
    ...
    public static final String KAFKA_GROUP_ID = "flink-wide-table-group";

    public static final String FLINK_CHECKPOINT_DIR = "file:///data/flink/checkpoints";
    public static final String FLINK_SAVEPOINT_DIR = "file:///data/flink/savepoints";

    public static final String WIDE_TABLE_NAME = "product_display_read_model";
