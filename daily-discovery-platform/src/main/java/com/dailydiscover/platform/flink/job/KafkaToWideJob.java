...
public class KafkaToWideJob {
    ...
    public static void main(String[] args) throws Exception {
        ...
        KafkaToWideJob job = new KafkaToWideJob();
        
        LOG.info("注册宽表表定义");
        job.wideSourceTableDdls().forEach(tEnv::executeSql);
        tEnv.executeSql(job.wideSinkTableDdl());
        tEnv.executeSql(job.wideInsertSql());
