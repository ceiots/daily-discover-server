...
-- 2. 初始化默认用户
INSERT INTO users (nickname, phone, password, bio, points, membership, avatar_url, phone_verified, status) VALUES
('设计生活家', '13800000000', '$2a$10$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', '记录生活，也创造生活', 300, '普通会员', NULL, TRUE, 'ACTIVE');
