...
**接口功能**: 购物车商品管理、数量更新、批量操作、选中状态管理等

**API端点**:
- 加入购物车: `POST ${API_BASE_URL}/cart/add`
- 获取购物车商品列表: `GET ${API_BASE_URL}/cart/items`
- 获取购物车商品详情: `GET ${API_BASE_URL}/cart/item/{cartItemId}`
- 获取购物车统计信息: `GET ${API_BASE_URL}/cart/total`
- 更新购物车商品数量: `PUT ${API_BASE_URL}/cart/update-quantity`
- 从购物车移除商品: `DELETE ${API_BASE_URL}/cart/remove/{cartItemId}`
- 批量删除购物车项: `POST ${API_BASE_URL}/cart/batch-remove`
- 清空购物车: `DELETE ${API_BASE_URL}/cart/clear`
- 更新购物车项选中状态: `PUT ${API_BASE_URL}/cart/update-selection`
- 批量更新购物车项选中状态: `POST ${API_BASE_URL}/cart/batch-update-selection`
- 获取选中的购物车项: `GET ${API_BASE_URL}/cart/selected`
- 合并购物车: `POST ${API_BASE_URL}/cart/merge`
