...
public class ProductController {
    ...
    public List<Product> getRecommendations(@RequestParam(required = false) Integer timeSlot) {
        String timeSlotStr;
        if (timeSlot != null) {
            // 前端传递数字时间段，转换为字符串
    ...
    public List<Product> getRecommendationsByTimeSlot(@PathVariable String timeSlot) {
    ...
    public List<Product> getSmartRecommendations(@RequestParam(defaultValue = "6") int limit) {
